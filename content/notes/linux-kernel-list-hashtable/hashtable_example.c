...
static void hash_add_same_key_example()
{
    // define a hash table with 2^3(=8) buckets
    DEFINE_HASHTABLE(htable, 3);
    // => struct hlist_head htable[8] = { [0 ... 7] = HLIST_HEAD_INIT };
...
{
    print_hash_values();
    printf("hashtable_example\n");
    hashtable_example();
    printf("hash_del_example\n");
    hash_del_example();
    printf("hash_add_same_key_example\n");
    hash_add_same_key_example();
    printf("hashtable_show_buckets\n");
